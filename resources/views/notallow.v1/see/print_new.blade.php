    ...
    <div class="seeprint">
        ...
        <table width="100%">
            <tr>
                ...
                <td style="text-align:right;">
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p class="x11">ເລກທີ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; @if($beta_enter[0]->enter_number) <label class="red"> {{ $beta_enter[0]->enter_number }} </label> @endif @if($beta_enter[0]->status=='SUCCESS' || $beta_enter[0]->status=='SIGNINED')   @endif/ ຄທບ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        ...
        <div   style="padding-left:5%;padding-right:10%;">
                <div class="sub-line">&nbsp;</div>
                    ...
                    <p class="x11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ຄະນະຄຸ້ມຄອງ ດ່ານສາກົນສິນຄ້າ ທ່າບົກທ່ານາແລ້ງ ອະນຸຍາດ ໃຫ້ລົດຂົນສົ່ງສິນຄ້າເຂົ້າໄປຮອດປາຍທາງໄດ້</b></p>
        ...
        <div class="sub-line">&nbsp;</div>
                    <p class="x14"> <b>ຫົວໜ້າຄະນະຄຸ້ມຄອງ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ດ່ານສາກົນສິນຄ້າທ່າບົກທ່ານາແລ້ງ </b> </p>
