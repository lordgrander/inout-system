                ...
                <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class=" items-center"> 
                                <input type="text" class="form-control" id="name" placeholder="ຊື່ບໍລິສັດ">  
                                <input type="text" class="form-control" id="owner_name" placeholder="ຊື່ເຈົ້າຂອງບໍລິສັດ"> 
                    ...
                    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                        ...
                        <button class="btn btn-outline-dark" id="add_new">ເພີ່ມຂໍ້ມູນ</button>
                        </div>
                                ...
                                <tbody id="build">
                                    ...
                                    @foreach ($beta_company_group as $row)
                                        <tr id="display_{{ $row->com_id }}" style="display:">
                                            <td width="1%">{{ $count }}</td>
                                            <td>
                                                <a href="{{ url('/add/com/'. $row->com_id .'/user') }}"><p id="display_name_{{ $row->com_id }}" data-name="{{ $row->com_name }}">{{ $row->com_name }}</p> </a>
                                            </td>
                                            <td>
                                            ...
                                            <td width="5%"><button data-index="{{ $row->com_id }}"  class="edit btn  btn-outline-dark" >Edit</button></td>
                                            <td width="5%"><button data-index="{{ $row->com_id }}"  class="btn_del btn  btn-outline-dark text-danger">Delete</button></td>
                                        </tr>
