                ...
                <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class=" items-center"> 
                                <input type="text" class="form-control" id="name" placeholder="ຊື່ພະນັກງານ"> <br>
                                <input type="text" class="form-control" id="email" placeholder="ເບີໂທ"> 
                        </div>
                                ...
                                <tbody id="build">
                                    ...
                                    @foreach ($beta_users as $row)
                                        <tr id="display_{{ $row->id }}" style="display:">
                                            ...
                                            <td width="5%"><button data-index="{{ $row->id }}"  class="edit btn btn-outline-dark" >Edit</button></td>
                                            <td width="5%"><button data-index="{{ $row->id }}"  class="btn_del btn btn-outline-dark text-danger">Delete</button></td>
                                        </tr>
