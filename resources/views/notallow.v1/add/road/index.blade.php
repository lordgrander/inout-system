                                ...
                                <tbody id="build">
                                    ...
                                    @foreach ($beta_road_select as $row)
                                        <tr id="display_{{ $row->road_id }}" style="display:">
                                            ...
                                            <td width="5%"><button data-index="{{ $row->road_id }}"  class="edit btn btn-outline-dark" >Edit</button></td>
                                            <td width="5%"><button data-index="{{ $row->road_id }}"  class="btn_del btn btn-outline-dark text-danger">Delete</button></td>
                                        </tr>
                                        ...
                                        <tr id="input_{{ $row->road_id }}" style="display:none;">
                                            ...
                                            <td width="5%"><button data-index="{{ $row->road_id }}"  class="edit_save btn btn-outline-dark" style="color:lime;">Update</button></td>
