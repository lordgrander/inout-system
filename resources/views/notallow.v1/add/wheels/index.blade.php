                                ...
                                <tbody id="build">
                                    ...
                                    @foreach ($beta_t_type as $row)
                                        <tr id="display_{{ $row->t_type_id }}" style="display:">
                                            <td width="1%">{{ $count }}</td>
                                            <td>
                                                <p id="display_name_{{ $row->t_type_id }}" data-name="{{ $row->t_type_name }}">{{ $row->t_type_name }}</p> 
                                            </td>
                                            <td width="5%"><button data-index="{{ $row->t_type_id }}"  class="edit btn btn-outline-dark" >Edit</button></td>
                                            <td width="5%"><button data-index="{{ $row->t_type_id }}"  class="btn_del btn btn-outline-dark text-danger">Delete</button></td>
                                        </tr>
                                        ...
                                        <tr id="input_{{ $row->t_type_id }}" style="display:none;">
                                            ...
                                            <td width="5%"><button data-index="{{ $row->t_type_id }}"  class="edit_save btn btn-outline-dark" style="color:lime;">Update</button></td>
