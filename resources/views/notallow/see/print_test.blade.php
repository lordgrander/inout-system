            ...
            <table width="100%">
                <tr>
                    ...
                    <td style="text-align:right;">
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <p class="x11">ເລກທີ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; @if($beta_enter[0]->enter_number) <label class="red"> {{ $beta_enter[0]->enter_number }} </label> @endif @if($beta_enter[0]->status=='SUCCESS' || $beta_enter[0]->status=='SIGNINED')   @endif/ ດລ1.ນວ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
            ...
            <div class="d-flex justify-content-between" >
                ...
                <div style="padding-left:5%;padding-right:10%;text-align:right; width:40%;"> 
                    <div class="sub-line">&nbsp;</div>
                        ...
                        <img src="{{ asset($beta_enter[0]->sign_url) }} "  style="width:60%;float:right;">
                        @endif
                        <br>
                        &nbsp;
                </div>
