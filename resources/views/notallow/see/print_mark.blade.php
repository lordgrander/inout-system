    ...
    <div  id="content" class="print "> 
        ...
        <div class="seeprint">
            ...
            <table width="100%">
                <tr>
                    <td>
                        ...
                        <p class="x11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ຈຸດບໍລິການທ່ານາແລ້ງ-ດົງໂພສີ</p>
                        <p>&nbsp;</p>
                    </td>
                ...
                <tr>
                    <td colspan="2" style="padding-left:12%;">
                        <p class="x11" style="text-indent: -0.50rem;">- ອີງຕາມ ດຳລັດວ່າດ້ວຍດ່ານ ເຂົ້າ-ອອກ ສປປລາວ ສະບັບເລກທີ 643/ລບ,ລົງວັນທີ 25 ພະຈິກ 2024.</p>
                        <p class="x11" style="text-indent: -0.50rem;">- ອີງຕາມ ຂໍ້ຕົກລົງຂອງທ່ານເຈົ້າຄອງ ນະຄອນຫຼວງວຽງຈັນ ວ່າດ້ວຍການ ຈັດຕັ້ງ ແລະ ເຄື່ອນໄຫວ ຂອງດ່ານສາກົນຂົວ &nbsp;&nbsp;ມິດຕະພາບ 1 ນະຄອນຫຼວງວຽງຈັນ (ສະບັບປັບປຸງ) ສະບັບເລກທີ 691/ຈນວ, ລົງວັນທີ 09 ກໍລະກົດ 2025.</p>
            ...
            <div class="sub-line">&nbsp;</div>
                ...
                <p class="x11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ຫ້ອງການບໍລິຫານ ດ່ານສາກົນສິນຄ້າ ຂົວມິດຕະພາບ 1 ນະຄອນຫຼວງວຽງຈັນ ( ຈຸດບໍລິການທ່ານາ-ແລ້ງດົງໂພສີ ) ອອກອະນຸຍາດ</b><b>   ລົດບັນທຸກຂົນສົ່ງສິນຄ້າເຂົ້າ-ອອກຜ່ານດ່ານໃຫ້ແກ່  ທ່ານ : {{ $com_owner_name }}, ບໍລິສັດ {{ $com_name }}, ຈຳນວນ :  {{ $ld++}} ຄັນ, ລະອຽດມີດັ່ງນີ້.</b></p>
                <p class="x11"></p> 
                ...
                <table class="table tablex table-bordered x10" id="myTable">
                    ...
                    <tr>
                        ...
                        <td class="td x10">{{ $row->t_type_name }} @if($row->rounds!=1 && $row->rounds !='') - ( {{ $row->rounds }} ຖ້ຽວ ) @endif  </td> 
                ...
                <div   style="padding-left:5%;padding-right:0%;">
                    <p class="x11" style="text-indent: -1rem;">2.	ຕົ້ນທາງອອກຈາກ: ດ່ານສາກົນມິດຕະພາບ 1 ນະຄອນຫລວງວຽງຈັນ ຈຸດບໍລິການທ່ານາແລ້ງ-ດົງໂພສີ.</p>
                ...
                <p class="x11">4.	ວັນທີເຂົ້າ : {{ date('d-m-Y',strtotime($beta_enter[0]->date_in)) }} ວັນທີອອກ : {{ date('d-m-Y',strtotime($beta_enter[0]->date_out)) }},ຂາອອກ ດ່ານສາກົນສີນຄ້າທ່າບົກທ່ານາແລ້ງ.</p>
            ...
            <div class="d-flex justify-content-between" >
                <div style="width:100%">
                    <div  style="padding-left:5%;padding-right:5%;">
                        ...
                        <p class="x9" style="text-indent: -0.50em;  "> • ກໍລະນີແລ່ນລົດບັນທຸກຂົນສົ່ງສິນຄ້າເຂົ້າພາຍໃນຕົວເມືອງ ນະຄອນຫຼວງວຽງຈັນ ຫ້າມຂົນສົ່ງໃນເວລາເລັ່ງດ່ວນໂມງເຂົ້າການ ເລີກການຄື : ຕອນເຊົ້າເລີ້ມແຕ່ເວລາ 6 : 00 ຫາ 9 : 00  ໂມງ, ຕອນທ່ຽງເລີ້ມແຕ່ 11 : 00 ຫາ 13 : 00  ໂມງ, ຕອນແລງເລີ້ມແຕ່  15 : 00 ຫາ 18 : 00 ໂມງແລງ.</p>
                        <p class="x9" style="text-indent: -0.50em;  ">•	ຫ້າມຈອດລົດຊະຊາຍຕາມເສັ້ນທາງກໍລະນີຈໍາເປັນຕ້ອງຈອດລໍຖ້າເຂົ້າຕົວເມືອງຕ້ອງໄດ້ເຂົ້າຈອດໃນສະຖານທີ່ເໝາະສົມນອກ ເສັ້ນທາງຫຼີກລ້ຽງຄວາມແອອັດໃນການສັນຈອນ ແລະ ອຸປະຕິເຫດ.</p>
                        <p class="x9" style="text-indent: -0.50em;  ">•	ຫ້າມນໍາໃຊ້ສະຖານທີ່ເສັ້ນທາງ, ແຄມທາງ ເປັນບ່ອນຄ່ຽນຖ່າຍສິນຄ້າຂື້ນ - ລົງຢ່າງເດັດຂາດ.</p>
                        <p class="x9" style="text-indent: -0.50em;  ">•	ລົດຂົນສົ່ງສິນຄ້າເຂົ້າ - ອອກດ່ານສາກົນຂົວມິດຕະພາບ 1 ນະຄອນຫຼວງວຽງຈັນ ເພື່ອໄປສົ່ງສິນຄ້າຢູ່ປາຍທາງ ພາຍຫຼັງລົງສິນຄ້າ ສໍາເລັັດແລ້ວໃຫ້ກັບຄືນທັນທີ ຫ້າມບໍ່ໃຫ້ໄປເຄື່ອນໄຫວຮັບເອົາສິນຄ້າຢູ່ຈຸດອື່ນໆ ເພື່ອສົ່ງອອກຄືນ.</p>
                    </div>
                </div>
                <div style="padding-left:5%;padding-right:10%;text-align:right; width:70%;"> 
                    <div class="sub-line">&nbsp;</div>
                        <p class="x14"> 
                            <b> 
                                &nbsp; 
                                @if($beta_enter[0]->boss_id=='13')
                                    ຮອງຫົວຫນ້າຄະນະຄຸ້ມຄອງດ່ານສາກົນຂົວມິດຕະພາບ 1
                                @else
                                    ຊທ ຫົວຫນ້າຫ້ອງການບໍລິຫານ
                                @endif
                            </b>
                        </p>
                        @if($beta_enter[0]->sign_url)
                            <img src="{{ asset($beta_enter[0]->sign_url) }} "  style=" float:right;width:50%;"> 
                        @endif
                        <br>
                        &nbsp;
                </div>
