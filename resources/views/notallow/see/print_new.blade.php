    ...
    <div  id="content" class="print "> 
        ...
        <div class="seeprint">
            ...
            <div class="sub-line">&nbsp;</div>
                ...
                <p class="x11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ຄະນະຄຸ້ມຄອງດ່ານສາກົນ ຂົວມິດຕະພາບ 1 ນະຄອນຫຼວງວຽງຈັນ ( ຈຸດບໍລິການທ່ານາ-ແລ້ງດົງໂພສີ ) ອອກອະນຸຍາດ</b><b> ລົດບັນທຸກຂົນສົ່ງສິນຄ້າເຂົ້າ-ອອກຜ່ານດ່ານໃຫ້ແກ່  ທ່ານ : {{ $com_owner_name }}, ບໍລິສັດ {{ $com_name }}, ຈຳນວນ :  {{ $ld++}} ຄັນ, ລະອຽດມີດັ່ງນີ້.</b></p>
                <p class="x11"></p> 
                ...
                <div style="padding-left:5%;padding-right:0%;">
                    ...
                    <p class="x11" style="text-indent: -1rem;">3.	ປາຍທາງ ບ້ານ {{ str_replace('ບ້ານ','',$beta_enter[0]->address) }} ເມືອງ {{ str_replace('ເມືອງ','',$beta_enter[0]->district) }} ແຂວງ {{ str_replace('ແຂວງ','',$beta_enter[0]->province) }}</p>
                    <!-- <p class="x11">5.	ເສັ້ນທາງກັບຄືນ: ກັບເສັ້ນທາງເດີມທີ່ໄດ້ອະນຸຍາດໃຫ້ເຂົ້າໄປ.</p> -->
                    <p class="x11" style="text-indent: -1rem;">4.	ວັນທີເຂົ້າ {{ date('d-m-Y',strtotime($beta_enter[0]->date_in)) }} ວັນທີອອກ {{ date('d-m-Y',strtotime($beta_enter[0]->date_out)) }},ຂາອອກດ່ານສາກົນຂົວມິດຕະພາບ 1 ນະຄອນຫລວງວຽງຈັນ ຈຸດບໍລິການທ່ານາແລ້ງ-ດົງໂພສີ.</p>
            ...
            <div class="d-flex justify-content-between" >
                <div style="width:100%">
                    <div  style="padding-left:5%;padding-right:5%;"> 
                        ...
                        <p class="x9" style="text-indent: -0.50em;  ">•	ລົດຂົນສົ່ງສິນຄ້າເຂົ້າ - ອອກດ່ານສາກົນຂົວມິດຕະພາບ 1 ນະຄອນຫຼວງວຽງຈັນ ເພື່ອໄປສົ່ງສິນຄ້າຢູ່ປາຍທາງ ພາຍຫຼັງລົງສິນຄ້າ ສໍາເລັດແລ້ວໃຫ້ກັບຄືນທັນທີ ຫ້າມບໍ່ໃຫ້ໄປເຄື່ອນໄຫວຮັບເອົາສິນຄ້າຢູ່ຈຸດອື່ນໆ ເພື່ອສົ່ງອອກຄືນ.</p>
                    </div>
                </div>
                <div style="padding-left:5%;padding-right:10%;text-align:right; width:40%;">
                    <div class="sub-line">&nbsp;</div>
                        <p class="x14"> <b> @if($beta_enter[0]->boss_id=='1') <label > ຊທ </label> @endif ຫົວໜ້າຫ້ອງການບໍລິຫານ </b> &nbsp;&nbsp;&nbsp;&nbsp;</p>
                        @if($beta_enter[0]->sign_url)
                        <img src="{{ asset($beta_enter[0]->sign_url) }} "  style="width:70%;float:right;">
                        @endif
                        <br>
                        &nbsp;
                </div>
