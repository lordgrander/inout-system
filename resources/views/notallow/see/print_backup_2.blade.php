    ...
    <div class="seeprint">
        ...
        <table width="100%">
            ...
            <tr>
                <td colspan="2" style="padding-left:12%;">
                    <p class="x11">- ອີງຕາມ ດຳລັດວ່າດ້ວຍດ່ານ ເຂົ້າ-ອອກ ສປປລາວ ສະບັບເລກທີ 643/ລບ,ລົງວັນທີ 25/11/2024 ແລະ ດຳລັດວ່າດ້ວຍທ່າບົກ ສະບັບເລກທີ 298/ລບ, ລົງວັນທີ 5/6/2024.</p>
                    <p class="x11">- ອີງຕາມ ຂໍ້ຕົກລົງຂອງທ່ານເຈົ້າຄອງ ນະຄອນຫຼວງວຽງຈັນ ວ່າດ້ວຍການ ຈັດຕັ້ງ ແລະ ເຄື່ອນໄຫວ ຂອງຄະນະຄຸ້ມຄອງດ່ານສາກົນສິນຄ້າ ທ່າບົກທ່ານາແລ້ງ ສະບັບເລກທີ 859/ຈນວ, ລົງວັນທີ 08 ສິງຫາ 2024.</p>
        ...
        <div   style="padding-left:5%;padding-right:10%;">
                <div class="sub-line">&nbsp;</div>
                    ...
                    <p class="x11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ຫ້ອງການບໍລິຫານ ດ່ານສາກົນສິນຄ້າ ທ່າບົກທ່ານາແລ້ງ ອອກອະນຸຍາດ ລົດບັນທຸກຂົນສົ່ງສິນຄ້າແລ່ນເຂົ້າໄປໃນເມືອງໃຫ້ແກ່ </b><b>  ທ່ານ : {{ $com_owner_name }}, ບໍລິສັດ {{ $com_name }}, ຈຳນວນ :  {{ $ld++}} ຄັນ, ລະອຽດມີດັ່ງນີ້.</b></p>
                    <p class="x11"></p> 
        ...
        <div class="sub-line">&nbsp;</div>
                    ...
                    <img src="{{ asset($beta_enter[0]->sign_url) }} "  style="width:28%;float:right;">
                    @endif
                    <br>
                    &nbsp;
                </div>
