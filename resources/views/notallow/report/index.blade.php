                            ...
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;.
                                            <button  class="btn btn-outline-dark total_i_vs_noi form-control">C report</button>
                                            
                                            <a href="{{ route('doc.cancel.index') }}">
                                                <button  class="btn btn-outline-dark total_i_vs_noi form-control">Set c</button>
                                            </a>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.total_i_vs_noi').on('click',function(){
                ...
                window.location.href = ('/admin/document/report/'+start+'/'+end+''); 
