                        ...
                        <center><br>
                            ...
                            <div style="padding:10px 5px 5px 5px;">
                                <table class="table-bordered table-hover" style="width:50%;">
                                    <tr>
                                        <td class="text-center" width="10%">ເດືອນ</td>
                                    ...
                                    @foreach($select AS $r)
                                        <tr>
                                            ...
                                            <td style="text-align:right">{{ number_format($r->total_unit) }} ຄັນ &nbsp;</td>
                                            <td></td>
                                        </tr>
                                        @php($total+=$r->total_unit) 
                                    @endforeach
                                        <tr>
                                            <td class="text-center">ລວມ</td>
                                            <td style="text-align:right">{{ number_format($total) }} ຄັນ &nbsp;</td>
                                            <td></td>
                                        </tr>
                                </table> 
                            </div>
...
<script>
            $('#date_pick').change(function() {
                let start = $(this).val();
                window.location.href = '/supreme/report/'+start;
            });
