                    ...
                    <div class="text-center" style="padding: 1% 20% 0% 20%;">
                        <div class="p-0"> 
                            <div class="murphy-input-wrap">
                                ...
                                <input type="text" class="form-control murphy-input" id="name" placeholder="ປ້ອນປະເພດລົດ">
                            </div>
                         </div> 
                        <!-- Action -->
                                ...
                                <tbody id="build">
                                    ...
                                    @foreach ($beta_main_road as $row)
                                        <tr id="display_{{ $row->main_road_id }}" style="display:">
                                            <td width="5%">{{ $count }}</td>
                                            <td>
                                                <label id="display_name_{{ $row->main_road_id }}" data-name="{{ $row->main_road_name }}">{{ $row->main_road_name }}</label> 
                                            </td>
                                            <td width="5%">
                                                <button data-index="{{ $row->main_road_id }}"  class="edit btn btn-outline-dark" >
                                            ...
                                            <td width="5%">
                                                <button data-index="{{ $row->main_road_id }}"  class="btn_del btn btn-outline-dark text-danger">
                                        ...
                                        <tr id="input_{{ $row->main_road_id }}" style="display:none;">
                                            ...
                                            <td width="5%"><button data-index="{{ $row->main_road_id }}"  class="edit_save btn btn-outline-dark" style="color:black;">Update</button></td>
