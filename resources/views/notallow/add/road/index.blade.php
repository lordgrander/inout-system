                    ...
                    <div class="text-center" style="padding: 1% 20% 0% 20%;">
                        <div class="p-0"> 
                            <div class="murphy-input-wrap">
                                ...
                                <input type="text" class="form-control murphy-input" id="name" placeholder="ປ້ອນຂໍ້ມູນສາຍທາງ ">
                            </div>
                         </div> 
                        <!-- Action -->
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody id="build">
                                    ...
                                    @foreach ($beta_road_select as $row)
                                        <tr id="display_{{ $row->road_id }}" style="display:">
                                            <td width="5%" class="text-center">{{ $count }}</td>
                                            <td>
                                                <p id="display_name_{{ $row->road_id }}" data-name="{{ $row->road_name }}">{{ $row->road_name }}</p> 
                                            </td>
                                            <td width="5%">
                                                <button data-index="{{ $row->road_id }}"  class="edit btn btn-outline-dark" >
                                            ...
                                            <td width="5%">
                                                <button data-index="{{ $row->road_id }}"  class="btn_del btn btn-outline-dark text-danger">
                                        ...
                                        <tr id="input_{{ $row->road_id }}" style="display:none;">
                                            <td width="1%">{{ $count++ }}</td>
                                            <td> 
                                                <input type="text" id="input_name_{{ $row->road_id }}" value="{{ $row->road_name }}" class="form-control" autocomplete="off">
                                            </td>
                                            <td width="5%"><button data-index="{{ $row->road_id }}"  class="edit_save btn btn-outline-dark" style="color:black;">Update</button></td>
                                            <td width="5%"><button data-index="{{ $row->road_id }}"  class="edit_cancel btn btn-outline-dark " style="color:red;">Cancel</button></td>
                                        </tr>
                                    @endforeach 
                                </tbody>
                            </table>
